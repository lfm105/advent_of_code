...
fn build_cache(
    ...
    controller_fastest_paths
        ...
        .for_each(|((src, target), cfp)| {
            // for each shortest path to press B from A
        ...
        .fold(0u64, |acc, (numerical_value, chars)| {
            ...
            for i in 0..chars.len() {
                ...
                let shortest_paths = match i {
                    0 => keypad_fastest_paths.get(&('A', chars[i])).unwrap(), // if it's the first character, we need to go from A to the current character
                ...
                let shortest_path_len = shortest_paths.iter().fold(u64::max_value(), |acc, fp| {
                    ...
                    for i in 0..fp.len() {
                        match i {
                            ...
                            } // if it's the first character, we need to go from A to the current character
                            _ => {
                                shortest_path_len_2 +=
